                                        ...
                                        <form action="#" method="post">
                                            <div className="py-2">
                                                <div className="w-full px-4 mb-3">
                                                    <label htmlFor="c_address" className="text-black">Full Name <span className=" text-red-500">*</span></label>
                                                ...
                                                <div className="w-full px-4 mb-3">
                                                    <label htmlFor="c_address" className="text-black">Email <span className=" text-red-500">*</span></label>
                                                ...
                                                <div className="form-group">
                                                    <div className="grid w-full px-4 mb-3">
                                                        ...
                                                        <input type="text" className="w-full h-12 pl-2 rounded-sm outline-none border-none bg-gray-200" id="c_address" name="c_address" placeholder="Street address" />
                                                    </div>
                                                </div>

                                                <div className="form-group w-full px-4 mb-3">
                                                    <input type="text" className="w-full h-12 pl-2 rounded-sm outline-none border-none bg-gray-200" placeholder="Apartment, suite, unit etc. (optional)" />
                                                </div>

                                                <div className="w-full px-4 mb-3">
                                                    <label htmlFor="c_state_country" className="text-black">Country</label>
                                                    <input type="text" className="w-full h-12 pl-2 rounded-sm outline-none border-none bg-gray-200" id="country" name="country" placeholder="State / Country" />
                                                </div>
                                                <div className="form-group ">
                                                    <div className="grid w-full px-4 mb-3">
                                                        <label htmlFor="c_address" className="text-black">State / Country <span className=" text-red-500">*</span></label>
                                                    ...
                                                    <div className="grid w-full px-4 mb-3">
                                                        ...
                                                        <input type="text" className="w-full h-12 pl-2 rounded-sm outline-none border-none bg-gray-200" id="c_postal_zip" name="c_postal_zip" placeholder="Postal / Zip" />
                                                    </div>
                                                </div>
                                                <div className="w-full px-4 mb-3">
